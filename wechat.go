...
// reply text message
func (this *Weixin) ReplyTextMsg(rw http.ResponseWriter, content string) error {
	var msg textMsg
	msg.MsgType = "text"
	msg.Content = content
...
// reply image message
func (this *Weixin) ReplyImageMsg(rw http.ResponseWriter, mediaId string) error {
	var msg imageMsg
	msg.MsgType = "image"
...
// reply voice message
func (this *Weixin) ReplyVoiceMsg(rw http.ResponseWriter, mediaId string) error {
	var msg voiceMsg
	msg.MsgType = "voice"
...
// reply video message
func (this *Weixin) ReplyVideoMsg(rw http.ResponseWriter, video *Video) error {
	var msg videoMsg
	msg.MsgType = "video"
	msg.Video = video
	return this.replyMsg(rw, &msg)
...
// reply music message
func (this *Weixin) ReplyMusicMsg(rw http.ResponseWriter, music *Music) error {
	var msg musicMsg
	msg.MsgType = "music"
	msg.Music = music
	return this.replyMsg(rw, &msg)
...
// reply news  message
func (this *Weixin) ReplyNewsMsg(rw http.ResponseWriter, articles *[]Article) error {
	var msg newsMsg
	msg.MsgType = "news"
...
// reply message
func (this *Weixin) replyMsg(rw http.ResponseWriter, msg interface{}) error {
...
// send text message
func (this *Weixin) SendTextMsg(touser string, content string) error {
	var msg textMsg
	msg.MsgType = "text"
...
// send image message
func (this *Weixin) SendImageMsg(touser string, mediaId string) error {
	var msg imageMsg
	msg.MsgType = "image"
	msg.Image.MediaId = mediaId
	return this.sendMsg(touser, &msg)
...
// send voice message
func (this *Weixin) SendVoiceMsg(touser string, mediaId string) error {
	var msg voiceMsg
	msg.MsgType = "voice"
	msg.Voice.MediaId = mediaId
	return this.sendMsg(touser, &msg)
...
// send video message
func (this *Weixin) SendVideoMsg(touser string, video *Video) error {
	var msg videoMsg
	msg.MsgType = "video"
	msg.Video = video
	return this.sendMsg(touser, &msg)
...
// send music message
func (this *Weixin) SendMusicMsg(touser string, music *Music) error {
	var msg musicMsg
	msg.MsgType = "music"
	msg.Music = music
	return this.sendMsg(touser, &msg)
...
// send news message
func (this *Weixin) SendNewsMsg(touser string, articles *[]Article) error {
	var msg newsMsg
	msg.MsgType = "news"
	msg.Articles.Item = articles
	return this.sendMsg(touser, &msg)
...
// send message
func (this *Weixin) sendMsg(touser string, msg interface{}) error {
	v := reflect.ValueOf(msg).Elem()
...
// 向全部用户群发图文消息
func (this *Weixin) sendNewsToALl(mediaId string) error {
...
// 向特定GroupId用户群发图文消息
func (this *Weixin) sendNewsToGroup(groupId string, mediaId string) error {
	var news newsGroupMsg
	news.MsgType = "mpnews"
...
// 群发消息
func (this *Weixin) sendGroupMsg(msg interface{}) error {
...
// get qrcode url
func (this *Weixin) GetQRCodeURL(ticket string) string {
	return "https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=" + ticket
}

// create permanent qrcode
func (this *Weixin) CreateQRScene(sceneId int64) (string, error) {
	var inf qrScene
...
func (this *Weixin) CreateQRLimitScene(expireSeconds, sceneId int64) (string, error) {
	var inf qrScene
...
func (this *Weixin) createQRCode(inf *qrScene) (string, error) {
...
func (this *Weixin) DownloadMediaFile(mediaId, fileName string) error {
...
func (this *Weixin) UploadMediaFile(mediaType, fileName string) (string, error) {
...
// create custom menu
func (this *Weixin) CreateCustomMenu(btn *[]Button) error {
	var menu struct {
...
// get custom menu
func (this *Weixin) GetCustomMenu() ([]Button, error) {
	var menu struct {
		Menu struct {
			Button []Button `json:"button"`
		} `json:"menu"`
...
// delete custom menu
func (this *Weixin) DeleteCustomMenu() error {
...
// get user info
func (this *Weixin) GetUserInfo(openId string) (UserInfo, error) {
	var uinf UserInfo
